...
const featuresData = [
  {
    ...
    description: "Podés pagar con tarjeta, débito, efectivo o con Cuotas sin Tarjeta.",
  },
  {
    id: 2,
    icon: FaTruck,
  ...
  },
  {
    ...
    icon: FaShieldAlt,
    title: "Seguridad",
    description: "No hay nada que no puedas hacer, porque estás siempre protegido.",
  },
];
